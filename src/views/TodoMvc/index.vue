  ...
  <div class="about">
    <section class="todoapp">
      ...
      <footer class="footer" v-show="state.todos.length" v-cloak>
        ...
        <ul class="filters">
          <li><a  @click="changeVisibility('all')" :class="{ selected: state.visibility == 'all' }">All</a></li>
          <li><a  @click="changeVisibility('active')" :class="{ selected: state.visibility == 'active' }">Active</a></li>
          <li><a  @click="changeVisibility('completed')" :class="{ selected: state.visibility == 'completed' }">Completed</a></li>
        </ul>
...
export default defineComponent({
  ...
  setup () {
    const todoStorage = todoStorageFun()
    // app initial state
